...
**Q:** 我想要自定义弹出框的外部布局，如何设置参数呢？<br>
**A:**<br>
1）**基础属性**：`containerSize`,`containerHeight`,`containerWidth`，这些属性你可以配合下面的高级属性来自定义其外部布局。<br>
2）**高级属性**： <br>
`marginToAnchorView`:弹出框视图到锚定视图的外部间距<br>
...
<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
 <img style="width:250px" src="https://jaychou202302.github.io/media/BRCPopUp/md2.png"/>
</div>

<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
 <img style="width:320px" src="https://jaychou202302.github.io/media/BRCPopUp/md3.png"/>
</div>



<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
 <img style="width:270px" src="https://jaychou202302.github.io/media/BRCPopUp/md4.png"/>
</div>
...
**Q:** 我想要自定义弹出框的父视图，应该如何设置参数？<br>
**A:**<br>
1）**基础参数**:<br>
`popUpSuperView`: 指定弹出框的父视图<br>
2）**高级参数**:<br>
`contextStyle`: 指定弹出框父视图的样式,分别为 `SuperView / ViewController / Window / SuperScrollView` <br>
> [!Note]
...
**Q:** 我想要自定义弹出框的弹出样式，应该如何设置参数？<br>
**A:**<br>
1）**基础参数**：<br>
`popUpDirection`,`hideAfterDelayDuration`:分别可以帮助你自定义弹出的方向和自动解散弹出<br>
视图的时间<br>
2）**高级参数**：<br>
`dismissMode`:该参数决定弹出框的解散模式，支持用户触碰弹出框背景视图，自动解散弹出框。你可以在 `delegate` 中获取到该事件的回调<br>

**Q:** 我想要自定义弹出框的动画样式，应该如何设置参数？<br>
**A:**<br>
1）**基础参数**：<br>
`popUpAnimationType`,`popUpAnimationDuration`:分别可以帮助你自定义弹出框的弹出动画样式和时长，内部以及自带有 **7** 种常用的弹出动画样式<br>
2）**高级参数**:<br>
`popUpAnimation`:自定义的 `CAAnimation` 弹出动画，该动画将会被添加到弹出框根视图layer上<br>
`bubbleAnchorPoint`: 当你自定义了 `popUpAnimation` 参数后，你或许需要通过自定义 `anchorPoint` 来辅助你完善弹出动画的效果。<br>
