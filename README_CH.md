...
**Q:** 我想要自定义弹出框的箭头样式，如何设置参数呢？
**A:** 
1）**基础属性**：`arrowRadius`,`arrowSize`,`arrowDirection`,`arrowRelativePosition`,`arrowAbsolutePosition`，需要注意的是当你设置了弹出框的 `popUpDirection` 属性后`arrowRelativePosition ` 这个属性将会跟随 `popUpDirection` 自适应设置。
2）**高级属性**：
`arrowCenterAlignToAnchor` 让箭头始终指向锚定视图的中心（除了少数情况下，设置的偏移过大，无法指向），建议打开

**Q:** 我想要自定义弹出框的外部布局，如何设置参数呢？
**A:**
1）**基础属性**：`containerSize`,`containerHeight`,`containerWidth`，这些属性你可以配合下面的高级属性来自定义其外部布局。
2）**高级属性**：
`marginToAnchorView`:弹出框视图到锚定视图的外部间距

<div style="display: flex; justify-content: center; align-items: center; height: 500px;background-color:#F3F5F7;border-radius:4px;">
    <!-- 容器 -->
    <div style="display: flex; flex-direction: column; align-items: center;">
        <!-- 上面的矩形和线条 -->
        <div style="display: flex; flex-direction: column; align-items: center;">
            <div style="width: 100px; height: 100px;  background-color:lightgray;border-radius:4px;display:flex;;align-items:center">
               <a style="color:black;text-align:center;flex=1;width:100px;font-weight:bold">弹出视图</a>
            </div>
              <div style="width: 2px; height: 20px; background-color: #9463FA;">
            </div>
            <a style="color:#9463FA">外边距</a>
            <div style="width: 2px; height: 20px; background-color: #9463FA;">
            </div>
        </div>
        <div style="display: flex; align-items: center;">
            <!-- 左边的矩形和线条 -->
            <div style="display: flex; flex-direction: row; align-items: center; margin-right: 0px;">
                 <div style="width: 100px; height: 100px;  background-color:lightgray;border-radius:4px;display:flex;;align-items:center">
               <a style="color:black;text-align:center;flex=1;width:100px;font-weight:bold">弹出视图</a>
            </div>
                <div style="width: 50px; height: 2px; background-color: #9463FA;"></div>
            </div>
            <!-- 中间的矩形 -->
            <div style="width: 100px; height: 100px; background-color: #9463FA;border-radius:4px;display:flex;align-items:center">
                <a style="color:white;text-align:center;flex=1;width:100px;font-weight:bold">锚定视图</a>
            </div>
            <!-- 右边的矩形和线条 -->
        ...
        <div style="display: flex; flex-direction: column; align-items: center; margin-top: 0px;">
            <div style="width: 2px; height: 50px; background-color: #9463FA;"></div>
     <div style="width: 100px; height: 100px;  background-color:lightgray;border-radius:4px;display:flex;;align-items:center">
               <a style="color:black;text-align:center;flex=1;width:100px;font-weight:bold">弹出视图</a>
            </div>
        </div>
...
<!-- 容器居中展示 -->
<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
     <div style="width: 200px; height: 80px;  background-color:lightgray;border-radius:4px;display:flex;;align-items:center">
               <a style="color:black;text-align:center;flex=1;width:200px;font-weight:bold">弹出视图</a>
    </div>
    <div style="display: flex; flex-direction: column; align-items: center; margin-left: 0px;">
    <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
    <a style="color:black;text-align:center;flex=1;width:100px;font-weight:bold">居中对齐</a>
    <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
    <div style="width: 80px; height: 80px;  background-color:#9463FA;border-radius:4px;display:flex;;align-items:center">
          <a style="color:white;text-align:center;flex=1;width:100px;font-weight:bold">锚定视图</a>
    </div> 
    </div>
</div>
...
<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
<div style="display: flex; flex-direction: column; justify-content: center; align-items: flex-start; height: 300px;padding-left: 20px;">
    <div style="width: 200px; height: 80px; background-color: lightgray; border-radius: 4px; display: flex; align-items: center;">
        <a style="color: black; text-align: center; flex: 1; width: 200px; font-weight: bold;">弹出视图</a>
    </div>
    <div style="display: flex; flex-direction: column; align-items: center; margin-left: 0px;">
        <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
        <a style="color: black; text-align: center; flex: 1; width: 100px; font-weight: bold;">居左对齐</a>
        <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
        <div style="width: 80px; height: 80px; background-color: #9463FA; border-radius: 4px; display: flex; align-items: center;">
            <a style="color: white; text-align: center; flex: 1; width: 100px; font-weight: bold;">锚定视图</a>
        </div>
...
<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
<!-- 容器居右展示 -->
<div style="display: flex; flex-direction: column; justify-content: center; align-items: flex-end; height: 300px; padding-right: 20px;">
    <div style="width: 200px; height: 80px; background-color: lightgray; border-radius: 4px; display: flex; align-items: center;">
        <a style="color: black; text-align: center; flex: 1; width: 200px; font-weight: bold;">弹出视图</a>
    </div>
    <div style="display: flex; flex-direction: column; align-items: center; margin-left: 0px;">
        <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
        <a style="color: black; text-align: center; flex: 1; width: 100px; font-weight: bold;">居右对齐</a>
        <div style="width: 2px; height: 20px; background-color: #9463FA;"></div>
        <div style="width: 80px; height: 80px; background-color: #9463FA; border-radius: 4px; display: flex; align-items: center;">
            <a style="color: white; text-align: center; flex: 1; width: 100px; font-weight: bold;">锚定视图</a>
        </div>
...
<div style="display: flex;flex-direction: column; justify-content: center; align-items: center; height: 300px; border: 1px solid #ccc; margin-bottom: 20px;border-radius:4px">
<!-- 容器居右展示 -->
<div style="display: flex; flex-direction: column; justify-content: center; height: 300px; padding-right: 20px;">
    <div style="width: 200px; height: 80px; background-color: lightgray; border-radius: 4px; display: flex; align-items: center;">
        <a style="color: black; text-align: center; flex: 1; width: 200px; font-weight: bold;">弹出视图</a>
    </div>
    <div style="display: flex; flex-direction: column; align-items: center; margin-left: 0px;">
        <div style="width: 2px; height: 20px; background-color: #9463FA;margin-left:140px"></div>
        <a style="color: black; text-align: center; flex: 1; width: 140px; font-weight: bold;margin-left:120px">居右对齐+偏移30</a>
        <div style="width: 2px; height: 20px; background-color: #9463FA;margin-left:195px"></div>
        <div style="width: 80px; height: 80px; background-color: #9463FA; border-radius: 4px; display: flex; align-items: center;margin-left:120px">
            <a style="color: white; text-align: center; flex: 1; width: 100px; font-weight: bold;">锚定视图</a>
        </div>
    </div>
</div>
...
**Q:** 我想要自定义弹出框的父视图，应该如何设置参数？
**A:**
1）**基础参数**:
`popUpSuperView`: 指定弹出框的父视图
2）**高级参数**:
`contextStyle`: 指定弹出框父视图的样式,分别为 `SuperView / ViewController / Window / SuperScrollView`
> [!Note]
...
**Q:** 我想要自定义弹出框的弹出样式，应该如何设置参数？
**A:**
1）**基础参数**：
`popUpDirection`,`hideAfterDelayDuration`:分别可以帮助你自定义弹出的方向和自动解散弹出
视图的时间
2）**高级参数**：
`dismissMode`:该参数决定弹出框的解散模式，支持用户触碰弹出框背景视图，自动解散弹出框。你可以在 `delegate` 中获取到该事件的回调

**Q:** 我想要自定义弹出框的动画样式，应该如何设置参数？
**A:**
1）**基础参数**：
`popUpAnimationType`,`popUpAnimationDuration`:分别可以帮助你自定义弹出框的弹出动画样式和时长，内部以及自带有 **7** 种常用的弹出动画样式
2）**高级参数**:
`popUpAnimation`:自定义的 `CAAnimation` 弹出动画，该动画将会被添加到弹出框根视图layer上
`bubbleAnchorPoint`: 当你自定义了 `popUpAnimation` 参数后，你或许需要通过自定义 `anchorPoint` 来辅助你完善弹出动画的效果。
